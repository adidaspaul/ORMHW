...
public class CreateDeveloperFormServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        companyService = new CompanyService(new CompanyRepository(dbConnector), companyConverter,
                developersConverter, projectsConverter);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/html/developers/createDeveloperForm.jsp").forward(req, resp);
    }
}
